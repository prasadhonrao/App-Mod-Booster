#!/bin/bash
# deploy-with-chat.sh - Deploy everything including GenAI (Azure OpenAI + AI Search) services
# This enables the full AI chat experience.
#
...
echo "==> Deploying Bicep infrastructure (App Service + SQL + GenAI)..."
...
echo ""
echo "====================================================="
echo " FULL DEPLOYMENT (with GenAI Chat) COMPLETE!"
echo "====================================================="
echo " App URL:  https://$(az webapp show --resource-group $RESOURCE_GROUP --name $APP_SERVICE_NAME --query defaultHostName -o tsv)/Index"
echo " Chat UI:  https://$(az webapp show --resource-group $RESOURCE_GROUP --name $APP_SERVICE_NAME --query defaultHostName -o tsv)/chatui/index.html"
